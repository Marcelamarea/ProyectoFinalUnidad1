...
<div class="container" style="padding-top: 2em;background-color: #EDEFF0;border-radius: 10px;">
  <h1>Actualizar Encuesta de consumo</h1>
  <form class="row g-3" action="actualizarregistro.php" method="POST">
    <input type="hidden" name="id" id="" value="<?php echo $vec[0] ?>">
    <div class="col-md-6">
        <label for="inputEmail4" class="form-label">Primer Nombre</label>
        <input value="<?php echo $vec[1]?>" name="nom1" type="text" class="form-control" id="inputEmail4">
    </div>
    <div class="col-md-6">
        <label for="inputPassword4" class="form-label">Segundo Nombre</label>
        <input value="<?php echo $vec[2]?>" name="nom2" type="text" class="form-control" id="inputPassword4">
    </div>
    <div class="col-md-6">
        <label for="inputEmail4" class="form-label">Primer Apellido</label>
        <input value="<?php echo $vec[3]?>" name="ape1" type="text" class="form-control" id="inputEmail4">
    </div>
    <div class="col-md-6">
        <label for="inputPassword4" class="form-label">Segundo Apellido</label>
        <input value="<?php echo $vec[4]?>" name="ape2" type="text" class="form-control" id="inputPassword4">
    </div>
    <div class="col-md-6">
        <label for="inputEmail4" class="form-label">Teléfono</label>
        <input value="<?php echo $vec[5]?>" name="tel" type="number" class="form-control" id="inputEmail4">
    </div>
    <div class="col-md-6">
        <label for="inputPassword4" class="form-label">Correo Electrónico</label>
        <input value="<?php echo $vec[6]?>" name="cor" type="email" class="form-control" id="inputPassword4">
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        ...
        <select id="inputState" class="form-select" name="sus">
          <option selected value="<?php echo $vec[7] ?>"><?php echo $vec[7] ?></option>
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="inputPassword4" name="can" value="<?php echo $vec[8]?>">
    </div>
    <div class="col-md-8">
        ...
        <select id="inputState" class="form-select" name="pro">
          <option selected value="<?php echo $vec[9] ?>"><?php echo $vec[9] ?></option>
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-primary mb-3" name="btn">Actualizar datos</button>
    </div>
  </form>
</div>
